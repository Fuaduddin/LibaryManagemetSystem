...
<ul class="nav navbar-nav navbar-right">
 <li><a href="logout.php"><span class="glyphicon glyphicon-log-in"></span>Log Out</a></li>
    ...
    <div class="container">
    <h1 style="text-align:center; margin-bottom:3%;">  Customer Details    </h1>
    <table class="table table-striped">
            ...
            <tbody>
                <?php
              $con = mysqli_connect("localhost","root","","ewuproject");
                $sql = "select * from register where Role ='customer' order by id";//ORDER BY id desc
                ...
                if(mysqli_num_rows($result)>0)
                {
                                ...
                                while($row = mysqli_fetch_assoc($result))
                                {
                                    ...
                                    echo "<td>";
                                        ...
                                        echo "<td>";
                                            ?>
                                            <a href="actable.php?del=<?php echo $row["id"];?>" style="text-align: right; font-family: cursive" class="btn btn-danger">Delete</a>
                                            <?php
                                        echo "</td>";
                                        echo "<td>";
                                        ?>
...
if(isset($_GET['del'])){
    ...
    $query = mysqli_query($con,$sql);
     if($query){
        ...
        echo '<script>window.location="ctable.php"</script>';
    }
    else{
