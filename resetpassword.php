...
<form class="form-horizontal" method="post" action="resetpassword.php"  enctype="multipart/form-data">
...
if(isset($_POST['submit'])){
    ...
    if($password==$confirmpassword)
    {
        ...
        if($query)
        {
            echo "<script type='text/javascript'> alert('You Scucessfully reset your password. Thank You')</script>";
